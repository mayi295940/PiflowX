 ...
 * @author mayi
 */
public class PipelineProjectDeletionOperation
    extends AbstractStructureOperation<
        RefProjectContentRequestRef.RefProjectContentRequestRefImpl, ResponseRef>
    implements ProjectDeletionOperation<
        RefProjectContentRequestRef.RefProjectContentRequestRefImpl> {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(PipelineProjectDeletionOperation.class);
  private static final String DELETE_PROJECT_PATH = "pipeline/outer/api/v1/project/workflow/delete";
  ...
  @Override
  public ResponseRef deleteProject(
      RefProjectContentRequestRef.RefProjectContentRequestRefImpl projectRef)
    ...
    try {
      ...
      LOGGER.error("Delete pipeline Project Exception", e);
      throw new ExternalOperationFailedException(
          90176, "Delete pipeline project by build url exception", e);
    ...
    try {
      ...
      LOGGER.info(
          "Start to update pipeline project. url: {}, method: {}, body: {}",
          url,
          HttpMethod.POST,
          entity);
      resMap =
      ...
      LOGGER.error("Delete pipeline Project Exception", e);
      throw new ExternalOperationFailedException(90176, "Delete pipeline project exception", e);
    }
    ...
    LOGGER.info("Deleted pipeline project ID: {}", projectRef.getRefProjectId());
