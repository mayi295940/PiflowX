 ...
 */
public class PipelineProjectSearchOperation
    extends AbstractStructureOperation<RefProjectContentRequestRefImpl, ProjectResponseRef>
    implements ProjectSearchOperation<RefProjectContentRequestRefImpl> {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(PipelineProjectSearchOperation.class);

  private static final String GET_PROJECT_PATH = "pipeline/outer/api/v1/project/workflow/get";
  ...
  @Override
  public ProjectResponseRef searchProject(RefProjectContentRequestRefImpl projectRef)
    ...
    try {
      ...
      LOGGER.error("Search pipeline project exception", e);
      throw new ExternalOperationFailedException(
          90176, "Search pipeline project by build url exception", e);
    ...
    try {
      ...
      LOGGER.error("Search pipeline project exception", e);
      throw new ExternalOperationFailedException(90176, "Search pipeline project exception", e);
    }
    ...
    Integer projectId =
        (Integer)
            ((Map<String, Object>) ((Map<String, Object>) resMap.get("data")).get("project_detail"))
                .get("project_id");
    LOGGER.info("Get pipeline project ID: {}", projectId);
