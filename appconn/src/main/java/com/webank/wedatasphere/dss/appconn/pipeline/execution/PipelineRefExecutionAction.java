 ...
 * @author mayi
 */
public class PipelineRefExecutionAction extends AbstractRefExecutionAction
    implements LongTermRefExecutionAction {
  ...
  public PipelineRefExecutionAction() {}

  public PipelineRefExecutionAction(String applicationId) {
    this.applicationId = applicationId;
  }

  public PipelineRefExecutionAction(String applicationId, String executionUser) {
    this.applicationId = applicationId;
