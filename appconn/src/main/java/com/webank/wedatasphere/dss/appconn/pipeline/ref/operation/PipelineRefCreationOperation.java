 ...
 * @author mayi
 */
public class PipelineRefCreationOperation
    extends PipelineDevelopmentOperation<
        DSSJobContentWithContextRequestRef, RefJobContentResponseRef>
    implements RefCreationOperation<ThirdlyRequestRef.DSSJobContentWithContextRequestRef> {

  @Override
  public RefJobContentResponseRef createRef(DSSJobContentWithContextRequestRef requestRef)
