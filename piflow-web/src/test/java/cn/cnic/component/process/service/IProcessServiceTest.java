...
public class IProcessServiceTest extends ApplicationTests {
  ...
  public void testLineChartVisualizationData() {
    String result =
        processServiceImpl.getVisualizationData(
            "application_1596710850427_0039", "LineChart8", "LINECHART", true);
  ...
  public void testPieChartVisualizationData() {
    String result =
        processServiceImpl.getVisualizationData(
            "application_1596710850427_0413", "PieChart", "PIECHART", true);
    System.out.println(result);
  }
  ...
  public void testHistogramVisualizationData() {
    String result =
        processServiceImpl.getVisualizationData(
            "application_1596710850427_4294", "Histogram", "HISTOGRAM", true);
    System.out.println(result);
  }
}
