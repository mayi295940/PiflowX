...
public class FlowStopsPublishingMapperTest extends ApplicationTests {
  ...
  public void testGetFlowIdByPublishingId() {
    List<String> flowIdByPublishingId =
        flowStopsPublishingMapper.getFlowIdByPublishingId("bff398355a5c41d8bd784803ac9fc9bb");
  ...
  public void testAddFlowStopsPublishingList() {
    ...
    int addFlowStopsPublishingList =
        flowStopsPublishingMapper.addFlowStopsPublishing(flowStopsPublishing);
    logger.info(addFlowStopsPublishingList + "");
  }

  @Test
  public void testGetStopsFlowStopsPublishingByPublishingId() {
    List<FlowStopsPublishingVo> flowStopsPublishingList =
        flowStopsPublishingMapper.getFlowStopsPublishingVoByPublishingId("XXX0");
