...
public interface StopsComponentGroupMapper {
  ...
  List<StopsComponentGroup> getStopGroupList(@Param("engineType") String engineType);
   ...
   */
  @Insert(
      "INSERT INTO flow_stops_groups(id,crt_dttm,crt_user,enable_flag,last_update_dttm,last_update_user,version,group_name,engine_type) " +
              "VALUES (#{id},#{crtDttm},#{crtUser},#{enableFlag},#{lastUpdateDttm},#{lastUpdateUser},#{version},#{groupName},#{engineType})")
  @Options(useGeneratedKeys = true, keyProperty = "id", keyColumn = "id")
  int insertStopGroup(StopsComponentGroup stopGroup);

  @Insert(
      "INSERT INTO association_groups_stops_template(groups_id,stops_template_id) " +
              "VALUES (#{groups_id},#{stops_template_id})")
