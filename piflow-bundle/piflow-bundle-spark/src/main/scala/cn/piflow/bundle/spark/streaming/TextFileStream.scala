...
class TextFileStream
  ...
  override def getPropertyDescriptor(): List[PropertyDescriptor] = {
    ...
    val directory = new PropertyDescriptor()
      ...
      .description("HDFS directory to monitor for new file. Files must be written to the monitored directory by \"moving\" them from another location within the same file system ")
      .defaultValue("")
      .required(true)
