  ...
  <section>
    ...
    <div :style="style">
      <vxe-table
        ...
        <vxe-table-column field="bundle" title="bundle" type="html"></vxe-table-column>
  ...
  methods: {
      ...
      if (checked){
        ...
        records.forEach((item)=>{
          if ( item.groupName){
            ...
            queryJson.bundle.push(item.bundle);
        ...
        if (!!row.groupName){
          ...
          queryJson.isShow = 0;
          queryJson.bundle.push(row.bundle);
      ...
      if (checked){
        ...
        getDataList.forEach((item)=>{
          item.stopsComponentVoList.forEach((items)=>{
            queryJson.bundle.push(items.bundle);
    ...
    searchEvent () {
      ...
      if (param) {
        ...
        const searchProps = ['groupName', 'bundle', 'owner', 'description']
